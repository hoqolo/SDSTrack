...
def build_dataloaders(cfg, settings):
    ...
    data_processing_train = processing.SDSTrackProcessing(search_area_factor=search_area_factor,
                                                       output_sz=output_sz,
    ...
    data_processing_val = processing.SDSTrackProcessing(search_area_factor=search_area_factor,
                                                     output_sz=output_sz,
                                                     center_jitter_factor=settings.center_jitter_factor,
                                                     scale_jitter_factor=settings.scale_jitter_factor,
                                                     mode='sequence',
...
def get_optimizer_scheduler(net, cfg):
    trainable_params = ['Adapter', 'multimodal']
    ...
    train = [n for n, p in net.named_parameters() if p.requires_grad and any([param in n for param in trainable_params])]
    tune = [n for n, p in net.named_parameters() if p.requires_grad and any([param in n for param in tuned_params])]
